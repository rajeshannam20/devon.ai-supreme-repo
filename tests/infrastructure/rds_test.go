...
import (
    ...
    "myproject/awsutils" // Adjust the import to your own package path
)
...
func TestRDSModule(t *testing.T) {
    ...
    test_structure.RunTestStage(t, "validate", func() {
        ...
        rdsInstance, err := awsutils.GetRdsInstanceDetails(region, rdsId)
        if err != nil {
        ...
        for i := 0; i < maxRetries; i++ {
            instanceStatus, err := awsutils.GetRdsInstanceStatus(region, rdsId)
            if err != nil {
